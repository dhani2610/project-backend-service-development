            ...
            <div class="tab-content pt-2">
              <div class="tab-pane fade show active profile-overview" id="profile-detail">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-9 col-md-8 mb-2">{{ $user->username ?? 'N/A' }}</div>
                </div>

                <div class="row">
                  <div class="col-lg-3 col-md-4 label mb-2">Email Address</div>
                  <div class="col-lg-9 col-md-8 mb-2">{{ $user->email ?? 'N/A' }}</div>
                </div>

                <div class="row">
                  <div class="col-lg-3 col-md-4 label mb-2">Number Phone</div>
                  <div class="col-lg-9 col-md-8 mb-2">{{ $user->tlp ?? 'N/A' }}</div>
                </div>

                <div class="row">
                  <div class="col-lg-3 col-md-4 label mb-2">Address</div>
                  <div class="col-lg-9 col-md-8 mb-2">{{ $user->alamat ?? 'N/A' }}</div>
                </div>
              ...
              <div class="tab-pane fade profile-edit" id="profile-edit">
                ...
                <form action="{{ route('profile.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="card-body">
                      ...
                      <div class="form-group mb-3">
                        <label for="alamat">Number Phone</label>
                        <input type="text" class="form-control @error('alamat') is-invalid @enderror" id="alamat" name="alamat" value="{{ old('tlp') ?? $user->tlp }}"  placeholder="Enter Number Phone">
                        @error('tlp')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control @error('alamat') is-invalid @enderror" id="alamat" name="alamat" value="{{ old('alamat') ?? $user->alamat }}"  placeholder="Enter Address">
                        @error('alamat')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                      ...
                      <div class="form-group mb-3">
                          ...
                          <img src="{{ asset('img/users/'.($user->avatar ?? 'user.pn g')) }}" width="110px"
                              class="image img" />
