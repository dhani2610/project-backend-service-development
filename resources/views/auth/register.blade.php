...
<html lang="en">
    ...
    <!-- <body data-layout="horizontal"> -->
        ...
        <div class="d-lg-flex half">
          {{-- <img
          src="{{ asset('frontend/img/banner2.png') }}"
                  ...
                  <div class="col-md-6">
                    <div class="mb-4 mb-md-5 text-center">
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-muted mt-2">Sign up to {{ $page_title }}.</p>
                        </div>
                    <form class="mt-4 pt-2" method="POST" action="{{ route('register-store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-floating form-floating-custom mb-4">
                          <input id="tlp" type="number" min="0" class="form-control  @error('tlp') is-invalid @enderror" name="tlp" value="{{ old('tlp') }}" required autofocus placeholder="Enter Number Phone">
                          <label for="input-username">Number Phone</label>
                          <div class="form-floating-icon">
                            <i data-feather="users"></i>
                          </div>
                          @error('tlp')
                        ...
                        <div class="form-floating form-floating-custom mb-4">
                          <textarea name="alamat" id="alamat" cols="30" rows="10" class="form-control  @error('tlp') is-invalid @enderror" required autofocus placeholder="Enter Address" style="height: 100px;">{{ old('tlp') }}</textarea>
                        ...
                        <div class="form-floating form-floating-custom mb-4">
                          <select class="form-control d-none" name="role" required autofocus>
                        ...
                        <div class="mb-3">
                            <button class="btn btn-primary w-100 waves-effect waves-light font-telkom" type="submit">Save</button>
                        </div>
                    </form>
                  </div>
                </div>
